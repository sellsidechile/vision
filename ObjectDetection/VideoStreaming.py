...
cap = cv2.VideoCapture(0)#'TestVideo/TestVideo1.mp4')
...
def generate():
    ...
    base_options = core.BaseOptions(file_name = 'models/Dataset900/custommodel00.tflite')#'models/custommodel.tflite')
    detection_options = processor.DetectionOptions(max_results = 10, score_threshold = 0.3) ### cambiar
    ...
    roi_position_entry = 0.3 #rigth
    roi_position_exit = 0.3 #left
